...
class ControladorInscripcion():
    ...
    def create(self, info_inscripcion):
        #Validar que la materia y el estudiante exista

        nueva_inscripcion = Inscripcion(info_inscripcion)
        return self.repo.save(nueva_inscripcion)
    ...
    def update(self, id, info_inscripcion):
        inscripcion_actualizada = Inscripcion(info_inscripcion)
        return self.repo.update(id, inscripcion_actualizada)
